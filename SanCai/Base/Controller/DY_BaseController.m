...
@interface DY_BaseController ()

@end

@implementation DY_BaseController
...
- (instancetype)init
{
    self = [super init];
    if (self) {
        if ([self isMemberOfClass:[DY_OcrMainController class]] ||
            [self isMemberOfClass:[DY_ForumController class]] ||
            [self isMemberOfClass:[DY_CenterController class]]
            )
        {
