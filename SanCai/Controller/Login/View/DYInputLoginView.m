...
@interface DYInputLoginView ()

@end

@implementation DYInputLoginView
...
-(void)_initSubviews {
    DYInputTextField *tf1 = [[DYInputTextField alloc] init];
    ...
    DYInputTextField *tf2 = [[DYInputTextField alloc] init];
