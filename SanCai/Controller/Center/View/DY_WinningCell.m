...
-(void)setWinModel:(DY_WinningModel *)winModel {
    ...
    if ([NSString isEmptyString:winModel.address]) {
        ...
        [_statusLabel.layer setBorderColor:kUIColorFromRGB(0x2aa515).CGColor];
        _statusLabel.textColor = kUIColorFromRGB(0x2aa515);
    }
